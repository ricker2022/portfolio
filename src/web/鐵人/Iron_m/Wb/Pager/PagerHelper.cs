...
namespace Wb.Pager
{
    public static class PagerHelper
    {
        ...
        public static MvcHtmlString Paging(this HtmlHelper helper, IPagedList pagedList, PagerOptions pagerOptions, string routeName, object routeValues)
        {
            if (pagedList == null)
                return Pager(helper, pagerOptions, null);
            return Pager(helper, pagedList.TotalItemCount, pagedList.PageSize, pagedList.CurrentPageIndex, null, null, pagerOptions, routeName, routeValues, null);
        ...
        public static MvcHtmlString BackendPager(this HtmlHelper helper, IPagedList pagedList)
        {
            if (pagedList == null)
                return Pager(helper, (PagerOptions)null, null);

            PagerOptions pagerOptions = new PagerOptions { PageIndexParameterName = "page", CssClass = "pagination", FirstPageText = "&laquo;", FirstPageParam = "class=\"btn \"", LastPageText = "&raquo;", LastPageParam = "class=\"btn \"", PrevPageText = "&#8249;", PrevPageParam = "class=\"btn \"", NextPageText = "&#8250;", NextPageParam = "class=\"btn \"",  DefaultSeparatorHtml = ""};
          

            return Pager(helper, pagedList.TotalItemCount, pagedList.PageSize, pagedList.CurrentPageIndex, null, null, pagerOptions, null, null, null);
        }

        public static MvcHtmlString FrontendPager(this HtmlHelper helper, IPagedList pagedList, string routeName, object routeValues)
        {
            if (pagedList == null)
                return Pager(helper, (PagerOptions)null, null);

            PagerOptions pagerOptions = new PagerOptions { PageIndexParameterName = "page_index", Id = "pages", FirstPageText = "", LastPageText = "", PrevPageText = "", PrevPageParam = "class=\"btn Previous\"", NextPageText = "", NextPageParam = "class=\"btn Next\"", SeparatorHtml = "<span>|</span>" };
        ...
        public static MvcHtmlString FrontendContent3Pager(this HtmlHelper helper, IPagedList pagedList, string routeName, object routeValues)
        {
            if (pagedList == null)
                return Pager(helper, (PagerOptions)null, null);

            PagerOptions pagerOptions = new PagerOptions { PageIndexParameterName = "param3", Id = "pager", ShowFirstLast = false, ShowPrevNext = false, PrevPageText = "", PrevPageParam = "class=\"page_left\"", NextPageText = "", NextPageParam = "class=\"page_right\"", SeparatorHtml = "", DefaultSeparatorHtml = "" };


            return Pager(helper, pagedList.TotalItemCount, pagedList.PageSize, pagedList.CurrentPageIndex, null, null, pagerOptions, routeName, routeValues, null);
        }

        public static MvcHtmlString FrontendContentPager(this HtmlHelper helper, IPagedList pagedList, string routeName, object routeValues)
        {
            if (pagedList == null)
                return Pager(helper, (PagerOptions)null, null);

            PagerOptions pagerOptions = new PagerOptions { PageIndexParameterName = "param1", Id = "pager", ShowFirstLast = false, ShowPrevNext = true, PrevPageText = "", PrevPageParam = "id=\"page_prev\" class=\"arrow\"", NextPageText = "", NextPageParam = "id=\"page_next\" class=\"arrow\"", SeparatorHtml = "", DefaultSeparatorHtml = "" };


            return Pager(helper, pagedList.TotalItemCount, pagedList.PageSize, pagedList.CurrentPageIndex, null, null, pagerOptions, routeName, routeValues, null);
        }

        public static MvcHtmlString FrontendContent2Pager(this HtmlHelper helper, IPagedList pagedList, string routeName, object routeValues)
        {
            if (pagedList == null)
                return Pager(helper, (PagerOptions)null, null);

            PagerOptions pagerOptions = new PagerOptions { PageIndexParameterName = "param2", Id = "pager_area", ShowFirstLast = false, ShowPrevNext = true, PrevPageText = "<< Previous", NextPageText = "Next >>", SeparatorHtml = "", DefaultSeparatorHtml = "" };


            return Pager(helper, pagedList.TotalItemCount, pagedList.PageSize, pagedList.CurrentPageIndex, null, null, pagerOptions, routeName, routeValues, null);
        }

        public static MvcHtmlString FrontendEventPager(this HtmlHelper helper, IPagedList pagedList, string routeName, object routeValues)
        {
            if (pagedList == null)
                return Pager(helper, (PagerOptions)null, null);

            PagerOptions pagerOptions = new PagerOptions { PageIndexParameterName = "param1", Id = "pager", ShowFirstLast = false, ShowPrevNext = false, PrevPageText = "", PrevPageParam = "class=\"page_left\"", NextPageText = "", NextPageParam = "class=\"page_right\"", SeparatorHtml = "", DefaultSeparatorHtml = "" };
