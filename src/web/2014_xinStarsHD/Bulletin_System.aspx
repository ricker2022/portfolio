<%@ Page Title="" Language="VB" MasterPageFile="Mob.master" AutoEventWireup="false" CodeFile="Bulletin_System.aspx.vb" Inherits="Bulletin_System" %>
    ...
    <div id="main">
        <div id="content">
            <div class="BulletinBtnArea">
                <a class="BulletinBtn select" href="Bulletin_System.aspx">系統公告</a>
                <a class="BulletinBtn" href="Bulletin_Event.aspx">活動公告</a>
            </div>
